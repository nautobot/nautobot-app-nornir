...
def dbshell(context, query="", input="", output=""):
    ...
    if "docker-compose.mysql.yml" in context.nautobot_plugin_nornir.compose_files:
    ...
    elif "docker-compose.postgres.yml" in context.nautobot_plugin_nornir.compose_files:
        command += [
            "--",
            service,
            "psql",
